...
- Line 82-84: For each locus, ideally, 50% of the alleles come from B73 and 50% of the alleles come from non-B73 according to NAM design, isn't it? I agree that non-B73 alleles were derived from 25 founder lines. If that is the point, the authors should explicitly explain what is the "statistical issues" for NAM design.

- Line 127: "Three models" or three different approaches? The use of "Model" can be confused with genetic models (i.e. additive or dominant models) and/or statistical models.
