...
\subsection*{S2 Table}
\label{Table_S2}
{\bf Separate QTL results of IBM and NAM RILs.} \DIFaddbegin \DIFadd{The markers used in the analysis can be accesed through panzea website.
}\DIFaddend 
...
\subsection*{S4 Table}
\label{Table_S4}
{\bf Joint QTL results of 25 NAM RIL subpopulations.} \DIFaddbegin \DIFadd{The markers used in the analysis can be accesed through panzea website.
}\DIFaddend 
