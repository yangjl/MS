...
\subsection*{S2 Table}
\label{Table_S2}
{\bf Separate QTL results of IBM and NAM RILs.} The markers used in the analysis can be accesed through Panzea website.
...
\subsection*{S4 Table}
\label{Table_S4}
{\bf Joint QTL results of 25 NAM RIL subpopulations.} The markers used in the analysis can be accesed through Panzea website.
