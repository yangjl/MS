...
During the years 2008-2011, the above populations were sequentially planted in Ames, IA (summer season) and in Molokai, HI (winter season). In each location of a year, subsets of entries (selected according to the similarity of the entries, i.e. several NAM subpopulations or a diallel population) were planted. Our experiment was an incomplete block design, where each location of a year was considered as a block. On average, ~1,000 entries were planted in a block and 5-12 plants of the same entry were grown within each row. The blocks forms one complete replication of all entries, therefore the design is not resolvable. All plants in each row were harvested and KRN counts were collected from mature ears. 
