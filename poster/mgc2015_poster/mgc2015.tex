...
\veryHuge \color{NavyBlue} \textbf{Utilizing Evolutionary Conservation Information to Improve Prediction Accuracy in Genomic Selection} \color{Black}\\ % Title
%\Huge\textit{An Exploration of Complexity}\\[2cm] % Subtitle
\huge \textbf{Jinliang Yang^1, Sofiane Mezmouk^{1,2}, Rita Mumm^3, and Jeffrey Ross-Ibarra^1 }\\[0.5cm] % Author(s)
%\huge Department of Plant Sciences, University of California, Davis, CA 95616, USA[0.4cm] \\ % University/organization
%\huge Current address: KWS SAAT AG, Grimsehlstr. 31, 37555 Einbeck, Germany[0.4cm]\\ % University/organization
%\huge Department of Crop Sciences, University of Illinois at Urbana-Champaign, Urbana, IL 61801, USA[0.4cm]\\ % University/organization
